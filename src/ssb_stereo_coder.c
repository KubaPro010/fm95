...
int main() {
    ...
    while (to_run) {
        ...
        for (int i = 0; i < BUFFER_SIZE; i++) {
            ...
            float lsb = (stereo_i*cos38-stereo_q*(sin38*0.675f)); // Compute LSB, as the Hilbert isn't perfect, i'll have to a bit silence down the Q carrier in order to make it better, also, it is just perfect as FM Stereo LSB shouldn't be fully LSB
